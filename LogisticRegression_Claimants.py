...
pred = logit_model.predict(c1.iloc[ :, 1: ])#only inputs
...
# filling all the cells with zeroes
test_data["test_pred"] = np.zeros(402)#402 observations in test data
